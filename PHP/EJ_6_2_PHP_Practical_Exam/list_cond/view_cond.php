...
<head>
    ...
    <title>View the listings you've searched!</title>
...
<body>
    <div class="container d-grid gap-3 bg-light">
        ...
        <a href="list_con.php" class="btn btn-secondary col-3" role="button">Back to previous page</a>
    <?php
        $country = trim(htmlspecialchars(strip_tags($_REQUEST["countr"]), ENT_QUOTES, "UTF-8"));
        ...
        FROM LISTING_DATA L INNER JOIN HOST_DATA H ON L.HOST_ID=H.HOST_ID WHERE COUNTRY = '$country'";

        $registros = mysqli_query($connect, $sql) or die("An issue has occured: " . mysqli_error($connect));
        ...
        while ($reg=mysqli_fetch_array($registros)) {
            ...
            echo "<td>" . "<a href='../list_all/delete_all.php?LISTING_ID=$reg[LISTING_ID]' class='btn btn-danger'>Delete</a>
                            <a href='../list_all/update_all.php?LISTING_ID=$reg[LISTING_ID]' class='btn btn-primary'>Update</a>" . "</td>";
            echo "</tr>";
        }
